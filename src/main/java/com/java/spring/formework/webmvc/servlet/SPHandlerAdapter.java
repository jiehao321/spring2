...
/**
 * @author holler
 * @date 2020-07-21 22:50
 */
public class SPHandlerAdapter {

    public boolean supports(Object handler){return (handler instanceof SPHandlerMapping);}

    SPModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        SPHandlerMapping handlerMapping = (SPHandlerMapping)handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == SPModelAndView.class;
        if(isModelAndView){
